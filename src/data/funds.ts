...
export interface FundRow {
  ...
  readonly isin: string,
  readonly name: string,
  readonly holdings: { ticker: string, isin: string, last: number, weight: number }[]
}

export const fundSlice: Slice<Record<string, Fund>, {}, "funds"> = createSlice<Record<string, Fund>, {}, "funds">({
  name: 'funds',
